...
class _ProfileRemoteDataSource implements ProfileRemoteDataSource {
  ...
  Future<MyProfileResponseModel> getMyProfile() async {
    ...
    final _options = _setStreamType<MyProfileResponseModel>(
    ...
    late MyProfileResponseModel _value;
    try {
      _value = MyProfileResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<MyProfileResponseModel> updatePhoto({required File photo}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
